...
import animation from '../../assets/Signup.json'
...
const SignUp = () => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row-reverse px-2 justify-center items-center w-full md:w-[900px] mx-auto">
                <div className="bg-gray-400 text-center p-10 rounded-lg flex-1">
