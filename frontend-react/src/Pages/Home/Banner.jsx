...
export const Banner = () => {
    return (
        <div className="max-w-screen-2xl mx-auto h-[540px] lg:h-[670px] px-3 lg:px-10 flex flex-col lg:flex-row items-center justify-center overflow-hidden gap-5 lg:gap-10 relative">
            ...
            <div className="w-2/3 lg:w-1/3 text-center lg:text-left space-y-2 lg:space-y-5 py-5">
                <h1 className="text-lg md:text-2xl lg:text-[40px] font-bold">Discover Unique Finds, Crafted Just for You</h1>
                <p className="text-[#616161] text-xs md:text-lg">Explore our handpicked collections and find the perfect items to elevate your lifestyle.</p>
